...
class _AddTaskPageState extends State<AddTaskPage> {
  ...
  Widget build(BuildContext context) {
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            MyInputField(title: "Medicine", hint: "Enter Your Medicine", controller: _medicineController,),
            MyInputField(title: "Dosage", hint: "Enter the dosage",controller: _dosageController,),
            MyInputField(title: "Date", hint:DateFormat.yMd().format(_selectedDate),
             ...
             Row(
                ...
                children: [
                  _colorPallete(),
                  MyButton(label: "Add Med", onTap: () => _validateDate(),)
                ],
             ),
           ],
          ),
   ...
   _validateDate(){
      ...
      else if(_dosageController.text.isEmpty || _dosageController.text.isEmpty){
